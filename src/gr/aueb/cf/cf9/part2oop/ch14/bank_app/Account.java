...
/**
 * Represents a bank account with support for transactions and custom error handling.
 */
public class Account {
     ...
     * @throws InsufficientBalanceException   if the balance is insufficient or
    ...
    public String accountToString() {
        return "Account Id: " + id + " IBAN: " + iban + " First Name: " + firstname +
                " Last Name: " + lastname + " SSN: " + ssn + " Balance: " + balance;
    }

    // Helper Method
    private boolean isSsnValid(String ssn) {
        // Safe check preventing NullPointerException if this.ssn is null
